...
export enum Endpoint {
  ...
  CHECK_COTTAGE_RESERVATION = "http://localhost:8084/reservations/checkCottageReservation/",
  CHECK_ADVENTURE_RESERVATION = "http://localhost:8084/reservations/checkAdventureReservation/",
